...
class CustomNeumorphicTheme extends ChangeNotifier {
  CustomNeumorphicTheme({
    this.outerShadow,
...
final darkNeumorphicTheme = CustomNeumorphicTheme(
  innerShadowColors: [
...
final lightNeumorphicTheme = CustomNeumorphicTheme(
